...
namespace esphome
{
  namespace as7343
  {
    ...
    public:
      ...
      void set_par_sensor(sensor::Sensor *sensor) { par_ = sensor; }
      void set_lux_sensor(sensor::Sensor *sensor) { lux_ = sensor; }
      void set_lux2_sensor(sensor::Sensor *sensor) { lux2_ = sensor; }
    ...
    protected:
      ...
      sensor::Sensor *par_{nullptr};
      sensor::Sensor *lux_{nullptr};
      sensor::Sensor *lux2_{nullptr};
      ...
      T get_highest_value(std::array<T, N> &data);
